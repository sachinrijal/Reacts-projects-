...
export default function StarRating({ maxRating = "" ,color='#fcc419' , size='48px' , className ="", messages=[] ,onSetRating }) {
...
function Star({ onClick, full ,handleMouseEnter , handleMouseLeave ,size ,color }) {
